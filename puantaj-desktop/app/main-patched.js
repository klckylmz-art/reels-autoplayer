...
function createWindow() {
  ...
  win.webContents.on('did-finish-load', async () => {
    try {
      for (const file of ['desktop-patch.js','payroll-utils.js','salary-prime-patch.js','group-utils.js','groups-patch.js','timesheet-grouping-patch.js','ui-behavior-patch.js']) {
